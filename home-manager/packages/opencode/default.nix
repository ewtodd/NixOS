...
in
{
  programs.opencode = {
    ...
    settings = {
      ...
      # Session titles are generated by the tiny always-resident
      # supra-title model on oracle (routed through litellm), never the
      # main model. small_model is opencode's knob for exactly that task.
      ...
      provider = {
        litellm = {
          ...
          models = {
            "supra-title" = {
              name = "Supra Title";
              # 50M always-resident title model on oracle. Registered so
              # small_model resolves; not meant for real conversations.
              tool_call = false;
            };
